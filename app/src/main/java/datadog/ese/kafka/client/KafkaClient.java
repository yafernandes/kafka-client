...
public abstract class KafkaClient implements Runnable {
    ...
    protected static final String PAYLOAD = "The quick brown fox jumps over the lazy dog";
    protected static final Logger logger = LoggerFactory.getLogger("com.datadog.demo");
